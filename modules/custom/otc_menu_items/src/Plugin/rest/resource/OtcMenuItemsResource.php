...
namespace Drupal\otc_menu_items\Plugin\rest\resource;
 ...
 * @RestResource(
 *   id = "otc_menu_item",
 *   label = @Translation("Otc Menu items per menu"),
 *   uri_paths = {
 *     "canonical" = "/api/{menu_name}/mega-menu"
 *   }
 * )
 */
class OtcMenuItemsResource extends ResourceBase {
  ...
  public function get($menu_name = NULL) {
    if ($menu_name) {
      ...
      if ($response instanceof CacheableResponseInterface) {
        $response->addCacheableDependency(new OtcMenuItemsCachableDepenency($menu_name, $this->minDepth, $this->maxDepth));
      }
